...
public class ActivationEmailService {
    ...
    public void sendActivationEmail(String toEmail, String token) {
        String activationLink = activationProperties.baseUrl() + "/api/auth/activate?token=" + token;
        try {
            ...
            log.error("Nie udało się wysłać maila aktywacyjnego do {}. Link: {}", toEmail, activationLink, ex);
